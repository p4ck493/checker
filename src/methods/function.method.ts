...
export function FunctionMethod<T extends typeof Function>(
  target: unknown
): target is T {
  try {
    return (
...
export function AsyncFunctionMethod(
  target: unknown
): target is "[object AsyncFunction]" {
  try {
...
export function GeneratorFunctionMethod(
  target: unknown
): target is "[object Generator]" {
  try {
